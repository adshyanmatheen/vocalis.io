...
from app.core.rate_limiter import RateLimitInfo, assessment_limiter
...
class AssessmentRateLimiter:
    ...
    async def check(self, *, user_id: int) -> RateLimitInfo:
        return await assessment_limiter.check(str(user_id))
